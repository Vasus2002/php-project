                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 ">
                        <div class="maintext text-center">
                            <span>Serve You Since 2022</span>
                            <h2>Welcome To Choco Factory</h2>
                            <p>we are provide best & delicious chocalates when you want.</p>                        
                            </div>  
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="text-center">
                                    ...
                                    <p>Order Chocalate online from CHOCO FACTORY and get it fast delivered.</p>                                
                                    </div> 
                            </div> 
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="text-center">
                                    ...
                                    <p>These lists,updated hourly,contain best-selling items.</p>
                                </div> 
                            </div> 
                        </div>  
                    </div>
